...
export const BytedanceColorIcon = (props: IconProps) => {
  ...
  return (
    <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" class={classes} stroke-width={strokeWidth} style={sizeStyle} stroke-linecap={strokeLinecap} stroke-linejoin={strokeLinejoin}><path d="M280.416 794.112 128 829.952v-636.32l152.416 35.84z" fill="#325AB4"/><path d="M928 828.48 800 864V160l128 35.52z" fill="#78E6DC"/><path d="M480 798.304 352 832V480l128 33.696z" fill="#3C8CFF"/><path d="M576 449.696 704 416v352l-128-33.696z" fill="#00C8D2"/></svg>
  )
}
...
export const OriginalSizeIcon = (props: IconProps) => {
  ...
  const sizeStyle = props.size
    ? isNumber(props.size)
      ...
      : props.size
    : undefined
  let classes = `${prefixCls} ${prefixCls}-original-size`

  if (props.spin) classes += ` ${prefixCls}-spin`

  return (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" class={classes} stroke-width={strokeWidth} style={sizeStyle} stroke-linecap={strokeLinecap} stroke-linejoin={strokeLinejoin}><path d="m5.5 11.5 5-2.5h1v32M34 11.5 39 9h1v32"/><path d="M24 17h1v1h-1v-1ZM24 30h1v1h-1v-1Z" fill="currentColor" stroke="none"/><path d="M24 17h1v1h-1v-1ZM24 30h1v1h-1v-1Z"/></svg>
  )
}